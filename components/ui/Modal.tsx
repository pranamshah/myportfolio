  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative w-full ${sizes[size]} card-luxury animate-fade-up max-h-[90vh] flex flex-col`}>
        <div className="flex items-center justify-between px-6 py-4 border-b border-surface-hover flex-shrink-0">
          <h3 className="font-display text-lg font-light text-ink">{title}</h3>
